    ...
    ((r = function (e, t) {
      ...
      if (
        ((a.defaults = {
          ...
          eventListToggler: !0,
          calendarEvents: myListToCalendar,
        }),
        ...
        (a.initials = {
          ...
          dates: {
            es: {
              ...
              noEventForToday: "No hay nada para hoy !Descansa!",
              noEventForThisDay: "Nada planeado para este día",
              previousYearText: "Año anterior",
              nextYearText: "Año siguiente",
              closeSidebarText: "Cerrar barra lateral",
              closeEventListText: "Cerrar lista de tareas",
            }
          },
        }),
        (a.initials.weekends = {
      ...
      (a.startingDay = null),
        ...
        (a.$label = {
          days: [],
          months: a.initials.dates[a.defaults.language].monthsShort,
    ...
    (r.prototype.buildTheBones = function () {
      ...
      if ((e.calculateDays(), !e.$elements.calendarEl.html())) {
        ...
        (t += "</ul>"),
          (t += "</div></div>"),
          (t +=
            '<div class="calendar-inner"><table class="calendar-table"><tr><th colspan="7">a</th></tr><tr class="calendar-header">');
